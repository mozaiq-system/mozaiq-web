...
export const RECOMMENDED_TAGS: RecommendedTag[] = [
  {
    ...
    videos: [
      "https://music.youtube.com/watch?v=VsjsJA0gbBg&si=_SXXDMkqAV_athtI",
      "https://music.youtube.com/watch?v=swEwypY9sDs&si=0t60pmJa1-WxIRfR",
  ...
  {
    tag: "GLIDE",
    description: "not my tase",
    videos: [
      "https://youtube.com/watch?v=mQ9MMigZNQk&si=E43kReBTyO8nchrz",
      "https://music.youtube.com/watch?v=IeV1sYaOFCE&si=DHlWKEbluoxMZ5MS",
      "https://music.youtube.com/watch?v=oYKwotHRdHo&si=AqtuhiFgi8du4ZKX",
      "https://youtube.com/watch?v=AgeT5YbHsE8&si=gbWaihYBPju3RZfJ",
    ],
  },
  {
    tag: "SHEENA ROLL",
    description: "Foolish heart",
    videos: [
